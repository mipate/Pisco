...
public class Aplicatie {
	...
	private JFrame frmInventory, frame3, frameEnterComponents, frameFindComponents, frameScanBarcode;
	...
	private JMenu mnBarcodes;
	private JMenuItem mntmScanBarcode;
	...
	private void initialize() {
		...
		frameScanBarcode = new ScanBarcode();
		...
		mnBarcodes = new JMenu("Barcodes");
		menuBar.add(mnBarcodes);
		
		mntmScanBarcode = new JMenuItem("Scan barcode");
		mntmScanBarcode.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				frameScanBarcode.setVisible(true);
			}
		});
		mnBarcodes.add(mntmScanBarcode);
	}
